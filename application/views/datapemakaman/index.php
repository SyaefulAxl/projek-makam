					...
					<div class="box">
						...
						<div class="box-body">
							<div class="table-responsive">
									...
									<tbody>
										...
										foreach ($pemakaman as $pemakaman) : ?>
											<tr>
												...
												<td>
													<div class="btn-group">
														<a href="<?php echo site_url('DataPemakaman/hapus/' . $pemakaman->id_makam) ?>"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button></a>
														<a href="<?php echo site_url('DataPemakaman/detail/' . $pemakaman->id_makam) ?>"><button type="button" class="btn btn-primary btn-sm ml-3 mr-3"><i class="fa fa-eye"></i></button></a>
														<a href="<?php echo site_url('DataPemakaman/edit/' . $pemakaman->id_makam) ?>"><button type="button" class="btn btn-warning btn-sm mr-3"><i class="fa fa-edit (alias)"></i></button></a>
													</div>
												</td>
											</tr>
										<?php
								...
								<a href="<?php echo base_url(); ?>DataPemakaman/tambah" class="btn btn-primary"> Tambah
									Data </a>
							</div>
						</div>
						<!-- /.box-body -->
